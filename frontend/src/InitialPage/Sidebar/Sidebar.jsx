                ...
                <ul>
                  ...
                  <li className="submenu-open">
                    ...
                    <ul>
                      ...
                      <li
                        className={
                          pathname.includes("warehouselist-product")
                            ? "active"
                            : ""
                        }
                      >
                        <Link
                          className={
                            pathname.includes("warehouselist-") ? "active" : ""
                          }
                          to="/dream-pos/product/warehouselist-product"
                        >
                          <FontAwesomeIcon icon={faBuilding} data-bs-toggle="tooltip" title="fa fa-building" />
                          <span>Warehouse</span>
                        </Link>
                      </li>
                      {selectedPermission?.productBarcode === true ? (
                        <li
                          className={
                  ...
                  <li className="submenu-open">
                    ...
                    <ul>
                      {selectedPermission?.saleView === true ? (
                        <li
                      ...
                      {/* {selectedPermission?.salesReturnView === true ? (
                        <li
                          className={
                      ...
                      {selectedPermission?.quotationView === true ? (
                        <li
                          className={
                  ...
                  <li className="submenu-open">
                    ...
                    <ul>
                      {selectedPermission?.purchaseView === true ? (
                        <li
                          className={
                      ...
                      {selectedPermission?.purchaseReturnView === true ? (
                        <li>
                  ...
                  {selectedPermission?.expenseView === true ? (
                    <li className="submenu-open">
                  ...
                  <li className="submenu-open">
                    ...
                    <ul>
                      {selectedPermission?.customerListView === true ? (
                        <li
                          className={
                      ...
                      {selectedPermission?.supplierListView === true ? (
                        <li
                          className={
                  ...
                  {selectedPermission?.reportView === true ? (
                    <li className="submenu-open">
                  ...
                  {selectedPermission?.userView === true ? (
                    <li className="submenu-open">
