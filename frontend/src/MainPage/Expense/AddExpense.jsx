...
const AddExpense = () => {
  ...
  const expenseData = { expensesDate, expensesCategory, amount, referenceNumber, expensesFor, description }
...
console.log('op: ', options);
  ...
  const addExpense = async (e) => {
    try {
      e.preventDefault();
      const response = await axios.post(`${expenseUrl}/add-expenses`, expenseData);
