...
const EditQuotation = () => {
  ...
  const salesDatas = { customerName, reference, startDate, orderTax, totalDiscount, shipping, description, grandTotalNumber, status, selectedProducts }
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(`${peopleUrl}/get-quotation-details/${id}`);
  ...
  const editQuotation = async (e) => {
    try {
      e.preventDefault();
      const response = await axios.put(`${peopleUrl}/edit-quotation/${id}`, salesDatas);
      if (response.data.success) {
        toast.success(response.data.message);
        history.push('/dream-pos/quotation/quotationlist-quotation');
      }
      // setGrandTotalNumber(grandTotal)
      history.push('/dream-pos/quotation/quotationlist-quotation');
    } catch (error) {
    ...
    <>
      <div className="page-wrapper">
        <div className="content">
          ...
          <form action="" onSubmit={editQuotation}>
            <div className="card">
