...
const ReturnIndex =({ match }) =>(
    <Switch>
        ...
        <Route path={`${match.url}/editsalesreturn-return/:id`} component={EditSalesReturn} />
        ...
        <Route path={`${match.url}/editpurchasereturn-return/:id`} component={EditPurchaseReturn} />
