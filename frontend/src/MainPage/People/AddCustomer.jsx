...
const AddCustomer = () => {
  ...
  const addCustomer = async (e) => {
    try {
      ...
      if (
        !customerName || !email || !phone || !country || !code || !zipCode || !address
      ) {
      ...
      if (image.length === 0) {
        ...
        const allData = { customerDatas, image }
        ...
        const allData = { customerDatas, image: uploadedImageUrl };
        console.log(allData);
              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className={`form-group ${submitClicked && !customerName ? "error" : ""
                      }`}>
                      <label
                        className={`${submitClicked && !customerName ? "error-message" : ""
                          }`}
                      >Customer Name</label>
                      <input type="text" name="customerName" value={customerName}
                        onChange={(e) => setCustomerName(e.target.value)}
                        className={`${submitClicked && !customerName ? "error" : ""
                          }`} />
