...
const PeopleIndex = ({ match}) =>(
    <Switch>
        ...
        <Route path={`${match.url}/editcustomer-people/:id`} component={EditCustomer} />
        ...
        <Route path={`${match.url}/editsupplier-people/:id`} component={EditSupplier} />
        ...
        <Route path={`${match.url}/editstore-people/:id`} component={EditStore} />
