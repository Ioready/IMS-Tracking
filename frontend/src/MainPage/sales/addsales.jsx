...
const Addsales = () => {
  ...
  const salesDatas = { customerName, startDate, supplierName, orderTax, totalDiscount, shipping, grandTotalNumber, status, data }
  ...
  const addSale = async (e) => {
    try {
      ...
      const response = await axios.post(`${peopleUrl}/add-sale`, salesDatas, {
        headers: {
          ...
          <div className="card">
            <div className="card-body">
              <div className="row">
                ...
                <div className="col-lg-3 col-sm-6 col-12">
                  <div className="form-group">
                    <label className={`${submitClicked && !supplierName ? 'error-message' : ''}`}>Supplier</label>
                    <Select2
                      className="select"
                      data={options1}
                      value={supplierName}
              ...
              <div className="row">
                    ...
                    <div className="total-order w-100 max-widthauto m-auto mb-4">
                      <ul>
                        <li>
                          ...
                          {/* <h1 hidden>{grandTotal = grandTotal.toFixed(2) + shipping}</h1> */}
                        </li>
                        <li className="total">
                          <h4>Grand Total</h4>
                ...
                <div className="col-lg-12">
                  <button type="submit" onClick={() => setGrandTotalNumber(grandTotal)} className="btn btn-submit me-2">
                    Submit
                  </button>
